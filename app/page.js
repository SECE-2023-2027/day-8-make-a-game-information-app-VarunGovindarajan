...
export default async function HomePage() {
  ...
  try {
    ...
    const queryBody = `
      fields name, cover.image_id, total_rating, slug;
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold mb-6 border-b border-gray-700 pb-2">Most Popular Games</h2>
      {error && <p className="text-red-500">Error fetching games: {error}</p>}
